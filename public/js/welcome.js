    ...
    <div id="welcomeContents" class="my-5 mx-auto text-left col-lg-10">
        ...
        <div class="my-4">
          ...
          ${latestDocs.length > 0 ?
            ...
            `
            <div>
              <div class="list border rounded-2 p-3" style="pointer-events: none; align-content: center; display: flex; flex-direction: column; justify-content: center; align-items: center;">
                <h6 class="text-truncate">새로운 문서를 작성해보세요!</h6>
                <blockquote class="mb-1 fs-6 fw-light lh-sm" style="text-align: center; margin: 0;">아래 글쓰기 버튼을 클릭해보세요!</blockquote>
              </div>
            </div>
            `
          }
